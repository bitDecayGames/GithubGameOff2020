...
class Dialogs {
    ...
    public static var DialogArray:Array<Array<String>> = [
        ["Oh look, another one came down.", "If you manage to live long enough to get some money, bring it back here for some items.", "I see you have $5 on you right now.", "How about you trade me that for this shovel to get you started?", "Use the arrow keys to move and Press 'Z' to interact with objects like my shop and ropes"],
